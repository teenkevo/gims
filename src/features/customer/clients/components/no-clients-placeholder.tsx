  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-1 text-center">
        ...
        />
        <h3 className="text-2xl font-bold tracking-tight">You have no clients</h3>
        <p className="text-sm text-muted-foreground">Let&apos;s start off with creating a client.</p>
