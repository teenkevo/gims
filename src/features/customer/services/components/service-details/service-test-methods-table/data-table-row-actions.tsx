...
import { DeleteTestMethodFromService } from "./row-actions/delete-test-method";
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            className="cursor-pointer text-sm font-medium text-muted-foreground hover:text-foreground transition-all"
            onClick={() => {
              if (service.testMethods && service.testMethods.length > 1) {
          ...
          >
            ...
            <span>Dissociate Test Method</span>
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
